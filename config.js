module.exports = {
	...
	adminId: "780349670509248562", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTMyNTc4NTE2OTAzNDA4ODQ2OA.GiPCH_.-_IsmM6iJ7gsWudaGAmTiCmIX8Yf1rvcOzpedg", //- Bot's Token
	clientId: process.env.clientId || "1325785169034088468", //- ID of the bot
	clientSecret: process.env.clientSecret || "-NyR35Zj6uEMQ_9-L_zXx0M5xY8obPyh", //- Client Secret of the bot
	...
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-
	nodes: [
		{
